...
FFMPEG_COMMAND = f"ffmpeg -i {VIDEO_FOLDER + VIDEO_FILE_NAME} -ac 2 -b:v 2000k -c:a aac -c:v libx264 -b:a 160k -vprofile high -bf 0 -strict experimental -f mp4 {MP4_NAME}"
