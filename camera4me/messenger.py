...
def __main_mq_client__():
	...
	parser.add_argument(
        '-a', '--action', required=False, choices=['sent', 'receive', 'delete'], help='action for backend message-queue service')

	parser.add_argument(
        '-n', '--name', required=False, type=str, help='message-queue name')
    parser.add_argument(
